  ...
  window.addEventListener('keydown', function(e) {
    ...
    void main(void) {
        ...
        var mata_kiri = new myObject(circle1_vertex, circle1_faces, shader_vertex_source, shader_fragment_source);
          ...
          //============MULUT===========
          var mulut_temp = [];
          mulut_temp = createBezierRectangularPrism(-0.15-0.18, -0.05+0.5, -0.2, 0.4, 0.2, 0.4, 0.15+0.18, -0.05+0.5, 1.1, 0, 0, 0, 100);
        ...
        var tangan_kiri= [];
        tangan_kiri = createEllipsoid(0.3,0.75,0.3,0.95
            +1
            ,-0.45,0,1,1,1);
        ...
        var tangan_kanan= [];
        tangan_kanan = createEllipsoid(0.3,0.75,0.3,-0.95
            -1
            ,-0.45,0,1,1,1);
        ...
        var garisKurva = [];
        garisKurva = createBezierRectangularPrism(-0.15, -0.05+1, 0, -0.15+1, 0, -0.15+1, 0.15, -0.05+1, 1.2, 0, 0, 0, 100);
        ...
        var kaki3 = [];
          ...
          var garisKurva1 = [];
        garisKurva1 = createBezierRectangularPrism(-0.15-0.05, -0.25+0.75+0.45, 0-0.05, 0.30+0.45, 0-0.05, 0.30+0.45, 0.15-0.05, -0.25+0.75+0.45, 1, 0, 0, 0, 100);
        ...
        var garisKurva2 = [];
        garisKurva2 = createBezierRectangularPrism(1*0.15-0.425+0.05, 1*0.15+0.9, 2*0.15-0.425, 0*0.15+0.9, 2*0.15-0.425, 0*0.15+0.9, 1*0.15-0.425+0.05, -1*0.15+0.9, 1, 0, 0, 0, 100);
        ...
        var garisKurva3 = [];
        garisKurva3 = createBezierRectangularPrism(-1*0.15+0.35-0.05, 1*0.15+0.9, -2*0.15+0.35, 0*0.15+0.9, -2*0.15+0.35, 0*0.15+0.9, -1*0.15+0.35-0.05, -1*0.15+0.9, 1, 0, 0, 0, 100);
        ...
        var animate = function(time) {
            if(time > 0) {
                ...
                for(let i =0; i<tanahijo.child.length;i++){
                    LIBS.set_I4(tanahijo.child[i].MOVEMATRIX);
                    temp = LIBS.get_I4();
                    tanahijo.child[i].MOVEMATRIX = LIBS.mul(tanahijo.MOVEMATRIX, temp);
                }
                ...
                for(let i =0; i<batang_pohon.child.length;i++){
                    LIBS.set_I4(batang_pohon.child[i].MOVEMATRIX);
                    temp = LIBS.get_I4();
                    batang_pohon.child[i].MOVEMATRIX = LIBS.mul(batang_pohon.MOVEMATRIX, temp);
                }

                LIBS.set_I4(bench1.MOVEMATRIX);
                temp =LIBS.get_I4();
                LIBS.translateX(temp,0);
                bench1.MOVEMATRIX = LIBS.mul(bench1.MOVEMATRIX, temp);
                temp =LIBS.get_I4();
                LIBS.rotateY(temp, THETA);
                +
                LIBS.rotateX(temp,PHI);
                ...
                for(let i =0; i<bench1.child.length;i++){
                    LIBS.set_I4(bench1.child[i].MOVEMATRIX);
                    temp = LIBS.get_I4();
                    bench1.child[i].MOVEMATRIX = LIBS.mul(bench1.MOVEMATRIX, temp);
                }
                ...
                for(let i =0; i<awan1.child.length;i++){
                    LIBS.set_I4(awan1.child[i].MOVEMATRIX);
                    temp = LIBS.get_I4();
                    awan1.child[i].MOVEMATRIX = LIBS.mul(awan1.MOVEMATRIX, temp);
                }
                ...
                for(let i =0; i<aca1.child.length;i++){
                    ...
                    temp = LIBS.get_I4();
                    aca1.child[i].MOVEMATRIX = LIBS.mul(aca1.MOVEMATRIX, temp);
                }
                ...
                for(let i =0; i<nando1.child.length;i++){
                    ...
                    temp = LIBS.get_I4();
                    nando1.child[i].MOVEMATRIX = LIBS.mul(nando1.MOVEMATRIX, temp);
                }
                ...
                for(let i =0; i<samObject1.child.length;i++){
                    ...
                    temp = LIBS.get_I4();
                    samObject1.child[i].MOVEMATRIX = LIBS.mul(samObject1.MOVEMATRIX, temp);
                }
