                ...
                if(time <=960){
                  if(time  > 600){
                    ...
                    //=============ACA==================
                      ...
                      LIBS.set_I4(aca1.child[12].MOVEMATRIX);
                          temp = LIBS.get_I4();
                          LIBS.translateX(temp,-5);
                          LIBS.translateY(temp,time*0.0025);
                          LIBS.rotateZ(temp,LIBS.degToRad(time * -0.20));
                          aca1.child[12].MOVEMATRIX = LIBS.mul(aca1.child[12].MOVEMATRIX, temp);
                      
                      LIBS.set_I4(aca1.child[13].MOVEMATRIX);
                          temp = LIBS.get_I4();
                          LIBS.translateX(temp,-5);
                          LIBS.translateY(temp,time*0.0025);
                          LIBS.rotateZ(temp,LIBS.degToRad(time * 0.20));
                          aca1.child[13].MOVEMATRIX = LIBS.mul(aca1.child[13].MOVEMATRIX, temp);
                    //==============NANDO===================
                      LIBS.set_I4(nando1.MOVEMATRIX);
                      temp = LIBS.get_I4();
                      LIBS.translateX(temp,0);
                      ...
                      LIBS.translateY(temp,time*0.0025);
                      LIBS.rotateZ(temp,LIBS.degToRad(time * 0.20));
                      nando1.child[14].MOVEMATRIX = LIBS.mul(nando1.child[14].MOVEMATRIX, temp);
                      ...
                      LIBS.translateY(temp,time*0.0025);
                      LIBS.rotateZ(temp,LIBS.degToRad(time * -0.20));
                      nando1.child[15].MOVEMATRIX = LIBS.mul(nando1.child[15].MOVEMATRIX, temp);
                      ...
                      LIBS.translateY(temp,time*0.0025);
                      LIBS.rotateZ(temp,LIBS.degToRad(time * -0.20));
                      samObject1.child[2].MOVEMATRIX = LIBS.mul(samObject1.child[2].MOVEMATRIX, temp);
                      LIBS.set_I4(samObject1.child[3].MOVEMATRIX);
                      temp = LIBS.get_I4();
                      LIBS.translateX(temp,5);
                      LIBS.translateY(temp,time*0.0025);
                      LIBS.rotateZ(temp,LIBS.degToRad(time * 0.20));
                      samObject1.child[3].MOVEMATRIX = LIBS.mul(samObject1.child[3].MOVEMATRIX, temp);
                      ...
                      LIBS.translateY(temp,time*0.0025);
                      LIBS.rotateZ(temp,LIBS.degToRad(time * 0.20));
                      samObject1.child[4].MOVEMATRIX = LIBS.mul(samObject1.child[4].MOVEMATRIX, temp);
                      LIBS.set_I4(samObject1.child[5].MOVEMATRIX);
                      temp = LIBS.get_I4();
                      LIBS.translateX(temp,5);
                      LIBS.translateY(temp,time*0.0025);
                      LIBS.rotateZ(temp,LIBS.degToRad(time * -0.20));
                      samObject1.child[5].MOVEMATRIX = LIBS.mul(samObject1.child[5].MOVEMATRIX, temp);
                  }
              }else {
                //================ACA==================
                  LIBS.set_I4(aca1.MOVEMATRIX);
